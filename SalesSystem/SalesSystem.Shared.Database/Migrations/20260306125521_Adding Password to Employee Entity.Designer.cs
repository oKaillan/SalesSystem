...
namespace SalesSystem.Migrations
{
    ...
    [Migration("20260306125521_Adding Password to Employee Entity")]
    partial class AddingPasswordtoEmployeeEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesSystem.Shared.Database.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SalesSystem.Shared.Database.Entities.ApplicationUser", null)
                        .WithMany()
